...
% n + 1 nodi (numerati da 1 a n+1) ed un intero j fra 1 e n + 1
% costruisce e disegna la base di Lagrange l_j costruita sui nodi assegnati.
% Si effettui il disegno di l_j(x) per valori di x nell' intervallo dei nodi.
