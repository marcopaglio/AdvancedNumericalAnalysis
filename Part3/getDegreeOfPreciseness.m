function [degree] = getDegreeOfPreciseness(a, b, nodes)
    % PRECISAZIONE: this function returns the exact degree of preciseness
    %               until n <= 7. Then weights of NewtonCotes are not very
    %               precise; in order to work, use a greater value of epsilon.
