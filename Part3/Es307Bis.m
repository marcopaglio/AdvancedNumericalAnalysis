...
% calculate degree of preciseness
...
while isEqual
    ...
    polynomialIntegralValue = polynomialIntegralValue + 2 * sum(polynomialBaseValues(2 : n * m));
    polynomialIntegralValue = polynomialIntegralValue * (b - a) / (2 * n * m);
