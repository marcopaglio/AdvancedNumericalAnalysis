% Scrivere un programma di tipo function che assegnato un intero n ed
% un intervallo [a; b] costruisce e disegna le n+1 basi di Berstein in [a; b].
...
%draw sum of bernstein' basis (in order to verify unity)
