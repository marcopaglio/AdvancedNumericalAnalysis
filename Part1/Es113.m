...
% PRECISAZIONE: Con 5 nodi vi è solo un'unica base b-spline di grado 3 
%               senza aggiungere altri nodi.
...
for p = 0 : p_max
    ...
    if max_i_used > 0
        ...
        title(strcat(int2str(p), '-degree B-spline bases with ', int2str(num_nodes), ' nodes.'));
        xlabel('x');
